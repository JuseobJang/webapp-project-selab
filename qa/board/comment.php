			...
			<li>
				<div id="co_<?php echo $row['co_no']?>" class="commentSet">
					<div class="commentInfo">
						<div class="commentId">Name: <span class="coId"><?php echo $row['co_id']?></span></div>
				...
				<ul class="twoDepth">
					<li>
						<div id="co_<?php echo $row2['co_no']?>" class="commentSet">
							<div class="commentInfo">
								<div class="commentId">Name:  <span class="coId"><?php echo $row2['co_id']?></span></div>
								<div class="commentBtn">
									<a href="#" class="comt modify">Modify</a>
									<a href="#" class="comt delete">Delete</a>
								</div>
...
<form action="comment_update.php" method="post">
	...
	<table>
		<tbody>
			<tr>
				<th scope="row"><label for="coId">ID</label></th>
			...
			<tr>
				<th scope="row"><label for="coContent">Contents</label></th>
